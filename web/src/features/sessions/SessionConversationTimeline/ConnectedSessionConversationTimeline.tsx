  ...
  return (
    <AnnotateDrawerController projectId={projectId}>
      {({ disabled: annotateDisabled, openDrawer: openAnnotateDrawer }) => (
        <CommentDrawerController projectId={projectId} allowReadOnly>
                      ...
                      onSelect: async (observation) => {
                        try {
                          const scores = filterAndValidateDbScoreList({
                            scores: await utils.events.scoresForTrace.fetch({
                              projectId,
                          ...
                          openAnnotateDrawer({
                            ...
                            scores:
                              toDomainArrayWithStringifiedMetadata(scores),
                            analyticsData: {
                              type: "trace",
                          ...
                          showErrorToast(
                            ...
                            "Please try opening the annotation drawer again.",
                          );
                        }
                      },
                    },
